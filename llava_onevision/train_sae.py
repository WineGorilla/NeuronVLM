"""
SAE 训练入口 — LLaVA-OneVision 版。
用法：python -m llava.train_sae
python -m llava.train_sae --max_steps 25000
"""
import os
import sys
import signal
...
from llava.dataset_llava import VisionTextDataset, build_collate
...
def train():
    ...
    os.makedirs(CFG.save_llava_dir, exist_ok=True)

    print("Loading LLaVA-OneVision:", CFG.llava_model_id)
